...
public class PersistFilterDiaryService {
    ...
    public PersistFilterDiaryService() {
    ...
    public void FilterDiaryVideos(Exchange exchange) {
                            ...
                            for (int j = 1; j < image.length(); ++j) {
                                ...
                                //if (dic2.has("comment") && !dic2.isNull("comment")) {
                                    ...
                                    if (dic2.has("link") && !dic2.isNull("link")) {
                                        ...
                                        System.out.println("Diary video ID: " + reference);
