...
public class FHIRGetObservationByPatientID {

    public FHIRGetObservationByPatientID() {
    ...
    public void GetResult(Exchange exchange) {
        ...
        System.out.println("Camel path observation id: "+patient_id);
        ...
        //try {
            ...
            String authUri = "http://x.x.x.x:8080/fhir/Observation?subject="+patient_id+ "&_count=1000"; // uri to service which you get the token from // USE THIS ONE IN PRODUCTION
