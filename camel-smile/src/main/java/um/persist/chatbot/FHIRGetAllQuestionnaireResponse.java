...
public class FHIRGetAllQuestionnaireResponse {

    public FHIRGetAllQuestionnaireResponse() {
    ...
    public void GetResult(Exchange exchange) {
        ...
        //try {
            ...
            String authUri = "http://x.x.x.x:8080/fhir/QuestionnaireResponse?patient="+user_id+ "&_count=1000"; // uri to service which you get the token from // USE THIS ONE IN PRODUCTION
