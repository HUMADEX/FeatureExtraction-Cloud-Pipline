...
@RestController
@RequestMapping("/fhir")
public class FHIRStorePatient {

    private static final String FHIR_SERVER_URL = "http://x.x.x.x:8080/fhir/Patient/";
    ...
    public ResponseEntity<Object> updateTaskStatus(@RequestHeader("Authorization") String apiKey, Exchange exchange) {
        ...
        System.out.println("FHIRStorePatientResponse: " + questID);
