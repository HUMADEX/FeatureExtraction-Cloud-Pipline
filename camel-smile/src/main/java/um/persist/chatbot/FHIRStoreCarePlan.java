...
@RestController
@RequestMapping("/fhir")
public class FHIRStoreCarePlan {

    private static final String FHIR_SERVER_URL = "http://x.x.x.x:8080/fhir/CarePlan/";

    @PostMapping("/store-careplan")
    public ResponseEntity<Object> updateTaskStatus(@RequestHeader("Authorization") String apiKey, Exchange exchange) {
        ...
        System.out.println("FHIRStoreCarePlan: " + questID);
