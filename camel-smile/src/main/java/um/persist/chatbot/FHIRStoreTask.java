...
@RestController
@RequestMapping("/fhir")
public class FHIRStoreTask {

    private static final String FHIR_SERVER_URL = "http://x.x.x.x:8080/fhir/Task/";

    @PostMapping("/store-task")
    public ResponseEntity<Object> updateTaskStatus(@RequestHeader("Authorization") String apiKey, Exchange exchange) {
        ...
        System.out.println("FHIRStoreTask: " + questID);
