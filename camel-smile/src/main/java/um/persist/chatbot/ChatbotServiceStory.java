...
public class ChatbotServiceStory {

    public ChatbotServiceStory() {
    ...
    public void GetResult(Exchange exchange) {
        ...
        //try {
            ...
            String authUri = "http://0.0.0.0:"+port+"/conversations/"+user_id+"/story"; // uri to service which you get the token from // USE THIS ONE IN PRODUCTION
			//String authUri = "http://x.x.x.x:5005/conversations/"+user_id+"/story";
            ResponseEntity<String> response =
                    restTemplate.exchange(authUri, HttpMethod.GET, entity, String.class);
