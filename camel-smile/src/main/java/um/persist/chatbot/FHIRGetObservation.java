...
public class FHIRGetObservation {

    public FHIRGetObservation() {
    ...
    public void GetResult(Exchange exchange) {
        ...
        String observation_id = (String) camelMessage.getHeader("id");
        System.out.println("Camel path observation id: "+observation_id);
        ...
        error.put("error", "wrong observation_id. check that you use the correct one");
        ...
        //try {
            ...
            String authUri = "http://x.x.x.x:8080/fhir/Observation/"+observation_id; // uri to service which you get the token from // USE THIS ONE IN PRODUCTION
