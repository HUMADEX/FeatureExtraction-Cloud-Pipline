...
class LanguageProcessor:
    ...
    def PrepareforCSV(self,analysissource):
        ...
        process = {
            ...
            "A2_sentiment_words":{"positive":{"percentage":[], "words_normalized" : []}, "negative":{"percentage":[], "words_normalized" : []}, "neutral":{"percentage":[], "words_normalized" : []} },
            ...
            "A3_explicit_deression_percentage": [],
            "A3_explicit_deression_words_normalized":[],
            "A4_absolutist_words_small_percentage": [],
            "A4_absolutist_words_small_normalized":[],
            "A4_absolutist_words_full_percentage": [],
            "A4_absolutist_words_full_normalized":[],
            "A5_pastwords_percentage": [],
            "A5_pastwords_normalized":[],
            "A611_sentece_length": [],
            "A612_sentece_complexity": [],
            #"A621_Lexical_diversity_words": [],
            #"A621_Lexical_diversity_words_percentage": [],
            #"A621_Lexical_diversity_words_normalized": [],
            "A621_Lexical_diversity_persentece": [],
            "A622_Lexical_spohistication": [],
            "A623_Lexical_density": [],
            "A2_sentiment_words_positive_percentage":[],
            "A2_sentiment_words_positive_words_normalized":[],
            "A2_sentiment_words_negative_percentage":[],
            "A2_sentiment_words_negative_words_normalized":[],
            "A2_sentiment_words_neutral_percentage":[],
            "A2_sentiment_words_neutral_words_normalized":[],
        ...
        for id in data:
            ...
            process["A1_first_p_pronouns_percentage"].append(videodetails["language"]["pronoun_fps"]["percentage"])
            process["A1_first_p_pronouns_words_normalized"].append(  
                round((videodetails["language"]["pronoun_fps"]["count"]/videodetails["words"])*1000,2)
                ) 
            
            #2.1 A2_use_of_first_p_pronouns: words
            process["A2_sentiment_words"]["positive"]["percentage"].append(videodetails["language"]["sentiment"]["word"]["positive"]["percentage"])
            process["A2_sentiment_words_positive_percentage"].append(videodetails["language"]["sentiment"]["word"]["positive"]["percentage"])
            
            process["A2_sentiment_words"]["positive"]["words_normalized"].append(  
                round((videodetails["language"]["sentiment"]["word"]["positive"]["count"]/videodetails["words"])*1000,2)
                ) 
            process["A2_sentiment_words_positive_words_normalized"].append(  
                round((videodetails["language"]["sentiment"]["word"]["positive"]["count"]/videodetails["words"])*1000,2)
                ) 
            
            process["A2_sentiment_words"]["negative"]["percentage"].append(videodetails["language"]["sentiment"]["word"]["negative"]["percentage"])
            process["A2_sentiment_words_negative_percentage"].append(videodetails["language"]["sentiment"]["word"]["negative"]["percentage"])
            process["A2_sentiment_words"]["negative"]["words_normalized"].append(  
                round((videodetails["language"]["sentiment"]["word"]["negative"]["count"]/videodetails["words"])*1000,2)
                ) 
            process["A2_sentiment_words_negative_words_normalized"].append(  
                round((videodetails["language"]["sentiment"]["word"]["negative"]["count"]/videodetails["words"])*1000,2)
                ) 
            
            
            process["A2_sentiment_words"]["neutral"]["percentage"].append(videodetails["language"]["sentiment"]["word"]["neutral"]["percentage"])
            process["A2_sentiment_words_neutral_percentage"].append(videodetails["language"]["sentiment"]["word"]["neutral"]["percentage"])
            process["A2_sentiment_words"]["neutral"]["words_normalized"].append(  
                round((videodetails["language"]["sentiment"]["word"]["neutral"]["count"]/videodetails["words"])*1000,2)
                )
            process["A2_sentiment_words_neutral_words_normalized"].append(  
                round((videodetails["language"]["sentiment"]["word"]["neutral"]["count"]/videodetails["words"])*1000,2)
                )
            ...
            process["A3_explicit_deression_percentage"].append(videodetails["language"]["depression_specific_words"]["percentage"])
            process["A3_explicit_deression_words_normalized"].append(  
                round((videodetails["language"]["depression_specific_words"]["count"]/videodetails["words"])*1000,2)
                ) 
            #4.1 A4_absolutist_words_small
            process["A4_absolutist_words_small_percentage"].append(videodetails["language"]["absolutist_words_small"]["percentage"])
            process["A4_absolutist_words_small_normalized"].append(  
                round((videodetails["language"]["absolutist_words_small"]["count"]/videodetails["words"])*1000,2)
                ) 
            #4.1 A4_absolutist_words_full
            process["A4_absolutist_words_full_percentage"].append(videodetails["language"]["absolutist_words_full"]["percentage"])
            process["A4_absolutist_words_full_normalized"].append(  
                round((videodetails["language"]["absolutist_words_full"]["count"]/videodetails["words"])*1000,2)
                )
            #5 A5_pastwords
            process["A5_pastwords_percentage"].append(videodetails["language"]["pastwords"]["percentage"])
            process["A5_pastwords_normalized"].append(  
                round((videodetails["language"]["pastwords"]["count"]/videodetails["words"])*1000,2)
                )
            #6.1.1: A611_sentece_length 
            process["A611_sentece_length"].append(videodetails["sentece_length_data"]["avg"])
        
            #6.1.2: A612_sentece_complexity 
            process["A612_sentece_complexity"].append(videodetails["clauses_data"]["avg"])
           ...
           #     )
            process["A621_Lexical_diversity_persentece"].append(videodetails["sentece_unique_words_data"]["avg"])
            
            #6.2.2: A622_Lexical_spohistication
            process["A622_Lexical_spohistication"].append(videodetails["lexsophistication_data"]["avg"])
            
            #6.2.3: A623_Lexical_density
            process["A623_Lexical_density"].append(round(sum(list(chain.from_iterable(videodetails["language"]["lexialspohistication_per_statement"]["map"])))*100/videodetails['words'],4)) 
